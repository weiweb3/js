...
export async function createContract({
  ...
  console.log(
    `Creating a new weiweb3 contracts project in ${chalk.green(root)}.`,
  );
  console.log();
  ...
  console.log(
    "    Compiles your contracts and detects weiweb3 extensions implemented on them.",
  );
  console.log();
  console.log(chalk.cyan(`  ${packageManager}${useYarn ? "" : " run"} deploy`));
  console.log("    Deploys your contracts with the weiweb3 deploy flow.");
  console.log();
  console.log(
    chalk.cyan(`  ${packageManager}${useYarn ? "" : " run"} release`),
  );
  console.log("    Releases your contracts with the weiweb3 release flow.");
  console.log();
