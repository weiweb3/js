...
\\_$$  _|  $$  __$$\\ $$ |$$  __$$\\ $$  __$$ |$$ | $$ | $$ |$$  __$$\\ $$  __$$\\ 
  ...
  program
    .name("weiweb3-cli")
    .description("Official weiweb3 command line interface")
    .version(cliVersion, "-v, --version");

  program
    .command("create [projectPath]")
    .description(
      "Create a web3 app from any of our official templates: https://github.com/weiweb3/",
    )
    ...
    .option(
      "-t, --template [name]",
      `A template to start your project from. You can use an template repository name from the official weiweb3 org.`,
    )
  ...
  program
    .command("build")
    .description("Compile contract and detect weiweb3 contract extensions")
  ...
  program
    .command("detect")
    .description(
      "(deprecated) Compile contracts and detect implemented weiweb3 contract extensions",
    )
    .option("-p, --path <project-path>", "path to project", ".")
    .option("-d, --debug", "show debug logs")
    .option("-a, --all", "run detection on all contracts")
