 ...
 * const storage = new Weiweb3Storage({ uploader, downloader, gatewayUrls });
 * ```
 *
 * @public
 */
export class Weiweb3Storage<T extends UploadOptions = IpfsUploadBatchOptions> {
  private uploader: IStorageUploader<T>;
  private downloader: IStorageDownloader;
  public gatewayUrls: GatewayUrls;

  constructor(options?: Weiweb3StorageOptions<T>) {
