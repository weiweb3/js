import { Q as QueryClientProviderWithDefault, c as createSOLQueryKeyWithNetwork, r as requiredParamInvariant, n as neverPersist, a as createSOLProgramQueryKey, e as ensureTWPrefix } from '../../dist/required-param-6039793b.esm.js';
import React, { useMemo, useContext, createContext, useState, useEffect } from 'react';
import { jsx } from 'react/jsx-runtime';
import { Weiweb3SDK, getUrlForNetwork } from '@weiweb3/sdk/solana';
import invariant from 'tiny-invariant';
import { PhantomWalletAdapter } from '@solana/wallet-adapter-phantom';
import { ConnectionProvider, WalletProvider, useWallet } from '@solana/wallet-adapter-react';
import { useQuery, useQueryClient, useMutation } from '@tanstack/react-query';

const Weiweb3AuthConfigContext = /*#__PURE__*/createContext(undefined);
const Weiweb3AuthConfigProvider = _ref => {
  ...
  return /*#__PURE__*/jsx(Weiweb3AuthConfigContext.Provider, {
    value: authConfig,
    children: children
  });
};
...
const Weiweb3SDKProvider = _ref => {
  ...
  return /*#__PURE__*/jsx(QueryClientProviderWithDefault, {
    ...
    children: /*#__PURE__*/jsx(Weiweb3AuthConfigProvider, {
      value: authConfig,
      children: /*#__PURE__*/jsx(Weiweb3SDKContext.Provider, {
        value: ctxValue,
        children: children
      })
    })
...
const Weiweb3SDKContext = /*#__PURE__*/createContext({
  sdk: null,
  desiredNetwork: "unknown"
});
function useSDK() {
  const ctxValue = useContext(Weiweb3SDKContext);
  invariant(ctxValue._inProvider, "useSDK must be used within a Weiweb3SDKProvider");
...
const Weiweb3Provider = _ref => {
  ...
  return /*#__PURE__*/jsx(ConnectionProvider, {
    ...
    children: /*#__PURE__*/jsx(WalletProvider, {
      ...
      children: /*#__PURE__*/jsx(Weiweb3WrapperProvider, {
        network: network,
...
const Weiweb3WrapperProvider = _ref2 => {
  ...
  const wallet = useWallet();
  return /*#__PURE__*/jsx(Weiweb3SDKProvider, {
    network: network,
    wallet: wallet,
    authConfig: authConfig,
    children: children
...
function programQuery(queryClient, sdk, address, type) {
  ...
  return {
    ...
    queryFn: async () => {
      requiredParamInvariant(sdk, "sdk is required");
      requiredParamInvariant(address, "Address is required"); // if the type is not passed in explicitly then we'll try to resolve it
...
function useUpdateRoyaltySettings(program) {
  const queryClient = useQueryClient();
  return useMutation(async sellerFeeBasisPoints => {
    requiredParamInvariant(program, "program is required");
...
function useMintToken(program) {
  ...
  return useMutation(async params => {
    requiredParamInvariant(program, "program is required"); // TODO switch this to use mintTo once that is exposed
...
function useLogin(config) {
  ...
  async function login(cfg) {
    invariant(authConfig, "Please specify an authConfig in the Weiweb3Provider");
...
export { Weiweb3Provider, Weiweb3SDKProvider, Weiweb3WrapperProvider, balanceQuery, claimConditionsQuery, dropTotalClaimedSupplyQuery, dropUnclaimedSupplyQuery, nftGetAllQuery, nftRoyaltyQuery, programAccountTypeQuery, programMetadataQuery, programQuery, tokenBalanceQuery, tokenSupplyQuery, useAuth, useBalance, useBurnNFT, useClaimConditions, useClaimNFT, useDropTotalClaimedSupply, useDropUnclaimedSupply, useLazyMint, useLogin, useLogout, useMintNFT, useMintNFTSupply, useMintToken, useNFTs, useProgram, useProgramAccountType, useProgramMetadata, useRoyaltySettings, useSDK, useSetClaimConditions, useTokenBalance, useTokenSupply, useTransferNFT, useTransferToken, useUpdateRoyaltySettings, useUser };
