...
var useConnect = require('../../../../dist/useConnect-46cac983.cjs.prod.js');
 ...
 *
 * ```javascript
 * import { useMagic } from "@weiweb3/react"
 * ```
 *
 *
 * @example
 * Before using this hook, you first need to set up the magic configuration in your `Weiweb3Provider`, including your magic API key.
 *
 * ```javascript
 ...
 * ]
 *
 * // Add the above to the walletConnectors prop of your <Weiweb3Provider />
...
function useMagic() {
  ...
  invariant__default["default"](wagmiContext, `useMagic() can only be used inside <Weiweb3Provider />. If you are using <Weiweb3SDKProvider /> you will have to use your own wallet-connection logic.`);
  ...
  invariant__default["default"](connector, "Magic connector not found, please make sure it is provided to your <Weiweb3Provider />");
