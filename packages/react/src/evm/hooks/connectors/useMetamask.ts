 ...
 *
 * ```javascript
 * import { useMetamask } from "@weiweb3/react"
 * ```
 *
 *
 * @example
...
export function useMetamask() {
  ...
  invariant(
    wagmiContext,
    `useMetamask() can only be used inside <Weiweb3Provider />. If you are using <Weiweb3SDKProvider /> you will have to use your own wallet-connection logic.`,
  );
  ...
  invariant(
    connector,
    "No connector found, please make sure you provide the InjectedConnector to your <Weiweb3Provider />",
  );
