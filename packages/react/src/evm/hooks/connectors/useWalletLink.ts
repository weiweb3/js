 ...
 *
 * ```javascript
 * import { useCoinbaseWallet } from "@weiweb3/react"
 * ```
 *
 *
 * @example
...
export function useCoinbaseWallet() {
  ...
  invariant(
    wagmiContext,
    `useCoinbaseWallet() can only be used inside <Weiweb3Provider />. If you are using <Weiweb3SDKProvider /> you will have to use your own wallet-connection logic.`,
  );
  ...
  invariant(
    connector,
    "Coinbase connector not found, please make sure it is provided to your <Weiweb3Provider />",
  );
