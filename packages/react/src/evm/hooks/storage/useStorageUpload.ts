...
import { IpfsUploadBatchOptions, UploadOptions } from "@weiweb3/storage";
 ...
 * using the `storageInterface` configured on the `Weiweb3Provider`
 *
 ...
 * @example
 * ```jsx
 * import { useStorageUpload } from "@weiweb3/react";
 *
