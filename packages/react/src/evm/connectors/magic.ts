...
export function useMagic() {
  ...
  invariant(
    wagmiContext,
    `useMagic() can only be used inside <Weiweb3Provider />. If you are using <Weiweb3SDKProvider /> you will have to use your own wallet-connection logic.`,
  );
  ...
  invariant(
    connector,
    "Magic connector not found, please make sure it is provided to your <Weiweb3Provider />",
  );
