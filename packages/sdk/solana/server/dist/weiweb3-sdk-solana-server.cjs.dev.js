...
var storage = require('@weiweb3/storage');
...
function createWeiweb3SDK(network) {
  let storage$1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new storage.Weiweb3Storage();
  const payer = getPayer();
  const signer = {
    publicKey: payer.publicKey,
    secretKey: payer.secretKey
  };
  const sdk$1 = sdk.Weiweb3SDK.fromNetwork(network, storage$1);
  sdk$1.wallet.connect(signer);
  return sdk$1;
}

exports.createWeiweb3SDK = createWeiweb3SDK;
