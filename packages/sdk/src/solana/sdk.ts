...
import { IpfsUploader, Weiweb3Storage } from "@weiweb3/storage";
import Bs58 from "bs58";

/**
 * The main entry-point for the weiweb3 Solana SDK.
 *
 * @example
 * ```jsx
...
export class Weiweb3SDK {
   ...
   */
  static fromNetwork(network: Network, storage?: Weiweb3Storage): Weiweb3SDK {
