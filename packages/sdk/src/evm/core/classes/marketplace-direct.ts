...
import ERC165Abi from "@weiweb3/contracts-js/dist/abis/IERC165.json";
...
import { ListingAddedEvent } from "@weiweb3/contracts-js/dist/declarations/src/Marketplace";
...
export class MarketplaceDirect {
   ...
   * @example
   * ```javascript
   * import { ChainId, NATIVE_TOKENS } from "@weiweb3/sdk";
   *
