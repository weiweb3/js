...
import type { IERC20, VoteERC20 } from "@weiweb3/contracts-js";
import ERC20Abi from "@weiweb3/contracts-js/dist/abis/IERC20.json";
import type ABI from "@weiweb3/contracts-js/dist/abis/VoteERC20.json";
import { ProposalCreatedEvent } from "@weiweb3/contracts-js/dist/declarations/src/VoteERC20";
 ...
 *
 * const sdk = new Weiweb3SDK("{{chainName}}");
