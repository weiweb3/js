...
export class ExtensionNotImplementedError extends Error {
  constructor(feature: Feature) {
    super(
      `This functionality is not available because the contract does not implement the '${feature.docLinks.contracts}' Extension. Learn how to unlock this functionality at https://portal.weiweb3.com/extensions `,
    );
  }
}
...
export class TransactionError extends Error {
  ...
  constructor(
    ...
    builtErrorMsg += "\n\n";
    builtErrorMsg +=
      "Need help with this error? Join our community: https://discord.gg/weiweb3";
    builtErrorMsg += "\n\n\n\n";
